...
def get_models():
    ...
    model_ext = [".pth"]
    model_dict = get_files(model_path, model_ext, os.path.join(folder_paths.cache_dir, 'BEN'))
    return model_dict
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "LayerMask: BenUltra": "LayerMask: Ben Ultra",
    "LayerMask: LoadBenModel": "LayerMask: Load Ben Model",
}
